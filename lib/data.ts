...
export type Server = { id: string; name: string; initials: string; accent: string; icon?: string; ownerId?: string; memberIds?: string[]; channels: Channel[]; roles?: Role[] };
export type Member = { id: string; name: string; username?: string; status: "online" | "idle" | "dnd" | "offline"; role: string; activity?: string; avatar: string; banner?: string; bio?: string; profileGradient?: ProfileGradient; plus?: boolean; plusBadgeVisible?: boolean; developer?: boolean; nicknameColor?: string; nicknameFont?: "default" | "serif" | "mono" | "rounded" };
