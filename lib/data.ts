...
export type Server = { id: string; name: string; initials: string; accent: string; icon?: string; banner?: string; ownerId?: string; memberIds?: string[]; channels: Channel[]; roles?: Role[]; roleAssignments?: Record<string, string[]> };
export type Member = { id: string; name: string; username?: string; status: "online" | "idle" | "dnd" | "offline"; role: string; activity?: string; avatar: string; banner?: string; bio?: string; profileGradient?: ProfileGradient; plus?: boolean; plusBadgeVisible?: boolean; developer?: boolean; nicknameColor?: string; nicknameFont?: "default" | "serif" | "mono" | "rounded"; adminNameGradient?: { from: string; to: string } | null };
